...
let shareLink=(req,res)=>{
 ...
 const mailOptions = {
  ...
  //html: "<p>Hi!,<br>Let\'s do a Group Chat.<a href='http://chatbox.gajalportfolio.xyz/group/"+req.body.roomId+"/"+req.body.roomName+"'>Click here</a> to Join!</p>"
  html:`Hi ${req.body.email}<br>
  someone has invited you to join a group chat.<br>
  <a href='http://chatbox.gajalportfolio.xyz/group/${req.body.roomId}/${req.body.roomName}'>Click here</a> to Join!<br>
