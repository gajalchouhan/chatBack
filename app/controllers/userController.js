...
let forgotPassword=(req,res)=>{
   ...
   // html: "<p>Hi there,,<br>Please <a href='http://chatbox.gajalportfolio.xyz/reset/"+emailEncrypt+"'>Click here</a> to change your password!</p>"
    html:`<p>Hi there,<p><br>
    Someone asked for a password reset for the email address ${ req.body.email }. Follow the link below:<br><br>
    <a href='http://chatbox.gajalportfolio.xyz/reset/${emailEncrypt}'>http://chatbox.gajalportfolio.xyz/reset/${emailEncrypt}</a><br><br>
