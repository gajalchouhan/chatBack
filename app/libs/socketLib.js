...
eventEmitter.on('WelcomeEmail', (data) => {
    ...
    const mailOptions = {
       ...
       // html: '<a href="http://chatbox.gajalportfolio.xyz/verify/'+data.hash+'">http://chatbox.gajalportfolio.xyz/' +data.hash+ '</a>'
        html: `Hi! ${data.name},<br>
        Please Click on the link to verify your email.<br>
        <a href="http://chatbox.gajalportfolio.xyz/verify/${data.hash}">http://chatbox.gajalportfolio.xyz/${data.hash}</a><br>
